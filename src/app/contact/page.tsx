          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-8 sm:p-12 shadow-2xl backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                ...
                className="w-12 h-12 rounded-lg bg-white/5 flex items-center justify-center hover:bg-white/10 transition-colors"
                aria-label="Instagram"
              >
                <svg className="w-6 h-6 text-[#E1306C]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a 
                ...
                aria-label="Email"
              >
                <svg className="w-6 h-6 text-[#EA4335]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
