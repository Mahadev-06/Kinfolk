  ...
  return (
    <>
      ...
      <main className="relative z-[1] animate-page-slide-up">
        ...
        {/* Footer */}
        <footer className="py-10 sm:py-12 border-t border-white/[0.06] bg-black">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-6 items-start text-center sm:text-left">
              ...
              <div className="flex flex-col items-center justify-center gap-2 pt-1 sm:pt-0">
                ...
                <span className="text-xs text-neutral-600">&copy; 2026 Kinfolk</span>
              </div>
              ...
              <div className="flex justify-center sm:justify-end">
                <div className="flex flex-col items-center sm:items-start gap-4">
                  ...
                  <div className="flex flex-col gap-4 sm:gap-3 text-sm text-neutral-500">
                    <a 
                    href="https://www.instagram.com/__.mahadev.__6?utm_source=qr&igsh=MWQxMWllZmJhYzd4Mg==" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group transition-colors flex items-center gap-3 hover:text-[#E1306C]"
                  >
                    <svg className="w-5 h-5 text-[#E1306C]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="group transition-colors flex items-center gap-3 hover:text-[#25D366]"
                  >
                  ...
                  <a 
                    ...
                    className="group transition-colors flex items-center gap-3 hover:text-[#EA4335]"
                  >
                    <svg className="w-5 h-5 text-[#EA4335]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
