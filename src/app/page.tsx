          ...
          <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-10 py-12 sm:py-16">
            <div className="flex flex-col md:flex-row md:justify-between gap-12 md:gap-8">
              ...
              <div className="flex flex-col gap-6 md:w-1/3">
                <div className="-ml-2">
                  <img src="/logo.png" alt="Kinfolk Logo" className="w-20 h-20 object-contain invert opacity-90" />
                </div>
                <div className="flex gap-3">
                  <a 
                    ...
                    className="w-10 h-10 rounded-lg bg-[#22171e] flex items-center justify-center hover:bg-[#33252d] hover:text-white transition-colors"
                  >
              ...
              {/* Col 3: Resources */}
              <div className="flex flex-col gap-6 md:w-1/3">
                <h3 className="text-white font-bold tracking-wider text-sm uppercase">Resources</h3>
                <ul className="flex flex-col gap-4 text-[15px]">
                  <li><a href="#" className="hover:text-white transition-colors">Facebook video downloader</a></li>
                  <li><a href="#" className="hover:text-white transition-colors">Instagram downloader</a></li>
                  <li><a href="#" className="hover:text-white transition-colors">Twitter downloader</a></li>
            ...
            <div className="mt-16 pt-8 border-t border-white/[0.06] text-sm">
              <p>&copy; 2026 Kinfolk. All rights reserved.</p>
            </div>
          </div>
        </footer>
    </main>
